...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class StackableParatroopersPowerInfo : ParatroopersPowerCAInfo
	{
	...
	public class StackableParatroopersPower : ParatroopersPowerCA
	{
		...
		protected override void Created(Actor self)
		{
			...
			if (stackManager == null)
				throw new InvalidOperationException($"{nameof(StackableParatroopersPower)} requires {nameof(StackableSupportPowerManager)} on the player actor.");
		...
		sealed class StackableSupportPowerInstance : SupportPowerInstanceCA, IStackableSupportPowerInstance
		{
			...
			public StackableSupportPowerInstance(string key, StackableParatroopersPowerInfo info, SupportPowerManager manager)
				: base(key, info, manager)
			{
				this.info = info;
				stackManager = manager.Self.TraitOrDefault<StackableSupportPowerManager>()
					?? throw new InvalidOperationException($"{nameof(StackableSupportPowerManager)} is required for {nameof(StackableParatroopersPower)}.");
			}
			...
			public int StackActivationIntervalTicks => info.StackActivationInterval;
