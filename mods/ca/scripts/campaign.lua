...
RebuildBuilding = function(building, player, loc, pos, attemptNumber, maxAttempts)
	...
	local buildTime = math.ceil(Actor.BuildTime(building.Type) * BuildTimeMultipliers[Difficulty])
...
UnitCompositions = {
	...
	Soviet = {
		Main = {
			...
			hard = {
				...
				{
					Infantry = { "e3", "e1", "e1", "e3", "shok", "e1", "shok", "e1", "e2", "e3", "e4" },
					Vehicles = { "3tnk", "4tnk", "btr.ai", "ttra", "v2rl", "v3rl" },
	...
	Scrin = {
		Main = {
			easy = {
				{
					Infantry = { "s3", "s1", "s1", "s1", "s3" },
					Vehicles = { "intl.ai2", "gunw" },
					MaxTime = DateTime.Minutes(14),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s3" },
			...
			normal = {
				{
					Infantry = { "s3", "s1", "s1", "s1", "s3", "s1" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw" },
					MaxTime = DateTime.Minutes(12),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s3", "s1", "s4", "s4" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw", "corr", "devo", "seek", "seek" },
					MinTime = DateTime.Minutes(12),
					MaxTime = DateTime.Minutes(15),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s1", "s1", "s2", "s2", "s3" },
					Vehicles = { "intl.ai2", "tpod", "gunw", "corr", "devo", "seek", "tpod", "seek" },
					MinTime = DateTime.Minutes(15),
				},
			},
			hard = {
				{
					Infantry = { "s3", "s1", "s1", "s1", "s3", "s3", "s4" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw", "seek" },
					MaxTime = DateTime.Minutes(10),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s1", "s1", "s2", "s2", "s3", "s3" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw", "corr", "devo", "seek", "tpod", "seek" },
					MinTime = DateTime.Minutes(10),
					MaxTime = DateTime.Minutes(13),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s1", "s1", "s2", "s2", "s3", "s3", "s3", "s4", "s4" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw", "corr", "devo", "seek", "tpod", "pac" },
					Aircraft = { "pac" },
					MinTime = DateTime.Minutes(13),
					MinTime = DateTime.Minutes(19),
				},
				{
					Infantry = { "s3", "s1", "s1", "s1", "s1", "s1", "s2", "s2", "s3", "s3", "s3", "s4", "s4" },
					Vehicles = { "intl.ai2", "intl.ai2", "gunw", "corr", "devo", "seek", "tpod", "pac", "pac" },
					Aircraft = { "pac", "pac" },
					MinTime = DateTime.Minutes(19),
				},
			}
