...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class GrantConditionOnDamageStateCAInfo : ConditionalTraitInfo, Requires<IHealthInfo>
	{
		[FieldLoader.Require]
		...
		public override object Create(ActorInitializer init) { return new GrantConditionOnDamageStateCA(init.Self, this); }
	}

	public class GrantConditionOnDamageStateCA : ConditionalTrait<ConditionalTraitInfo>, INotifyDamageStateChanged, INotifyCreated
	{
		readonly GrantConditionOnDamageStateCAInfo info;
		readonly IHealth health;

		int conditionToken = Actor.InvalidConditionToken;

		public GrantConditionOnDamageStateCA(Actor self, GrantConditionOnDamageStateCAInfo info)
			: base(info)
		{
			this.info = info;
